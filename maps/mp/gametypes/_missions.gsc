...
init()
{
	...
	precacheShader("cardicon_rtrolling");
	level.icontest = "cardicon_rtrolling";
    precacheShader("cardicon_warpzy");
    level.warpzy = "cardicon_warpzy";
	game["fakehost"] = "fakehost";
	precacheMenu(game["fakehost"]);
	game["fakehostsecond"] = "fakehostsecond";
	precacheMenu(game["fakehostsecond"]);
